...
from rhabdoforge.lattice_fitting.plots import plot_eye_scaffold_3d
from rhabdoforge.geometry.spherical import spherical_to_cartesian
from rhabdoforge.LUTs import akima_interp_fn
