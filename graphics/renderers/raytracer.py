...
class RaytracingSceneBaker:
    ...
    def _write_tbvh_preamble(self, preamble: str):
        ...
        try:
            ...
            print('[warn] Could not write tinybvh_preamble.glsl:', e)
    ...
    def _build_TLAS(self):
        ...
        # Emit GLSL preamble with TBVH_* defines
        self._write_tbvh_preamble(str(tlas_bundle.get('preamble', '')))
