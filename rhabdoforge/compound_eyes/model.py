...
from rhabdoforge.geometry.lattice import lattice_confidence
from rhabdoforge.geometry.circular import resultant
from rhabdoforge.geometry.hexatic import hexatic_axis_angle, hexatic_order
from rhabdoforge.geometry.linalg import tangent_frames, local_to_world, tangent_bearing
from rhabdoforge.geometry.neighbours import (
    knn, topological_spacing, metric_spacing, delaunay_neighbours, padded_neighbours, identify_boundary_points
)
from rhabdoforge.geometry.fields import smooth_phasors, smooth_field_partitioned
...
from rhabdoforge.compound_eyes.helpers.neural_superposition import (
...
if TYPE_CHECKING:
    ...
    from rhabdoforge.compound_eyes.helpers.alignment import AlignmentResult
