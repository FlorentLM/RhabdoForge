...
from rhabdoforge.types import UNWIRED_SRC
...
from rhabdoforge.geometry.linalg import rotate2d, local_to_world, project_to_tangent

if TYPE_CHECKING:
    from rhabdoforge.compound_eyes.model import Model
    from rhabdoforge.compound_eyes.views import OmmatidiumView, NeighbourResult
